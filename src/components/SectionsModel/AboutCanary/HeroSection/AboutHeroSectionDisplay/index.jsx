  ...
  return (
    <div className="relative">
      ...
      <div className="absolute left-5 right-5 bottom-10 md:left-20 md:right-auto md:w-1/2">
        <TextDisplay className="w-full text-3xl md:text-5xl font-semibold text-white outline-none bg-transparent" value={title} />
        <TextDisplay type="textarea" className="w-full text-base md:text-lg text-white mt-4 outline-none bg-transparent resize-none" value={description} rows="4" />
      </div>
    </div>
  );
};
