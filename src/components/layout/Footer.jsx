      ...
      <div className="w-full flex">
        <div className="w-1/2 px-10">
          <div className="h-16 flex items-center">
            <div
              className="h-11 bg-primary-bg rounded-full w-11 bg-cover bg-center"
              style={{ backgroundImage: `url("${logo}")` }}
            ></div>
            <div className="ml-4 font-bold ">CANARY</div>
          </div>
          <p>
            Website CANARY - Nền tảng gây quỹ cộng đồng trực tuyến tiện lợi, tin
            cậy và minh bạch.
          </p>
          <br />
          ...
          <p>
            Địa chỉ: lô A2 Trần Đăng Ninh, P.Hòa Cường Bắc, Q.Hải Châu, Đà Nẵng
          </p>
        </div>
