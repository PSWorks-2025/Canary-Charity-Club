...
const ProjectLayoutSection = ({ listData }) => {
  return (
    <section className="flex flex-col items-center">
      <TextDisplay
        value="Dự án & hoạt động nổi bật đã thực hiện"
        className="text-2xl pt-20 font-bold mb-4"
      />
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-3/5 max-w-6xl mb-10">
        {Object.entries(listData).map(([id, project]) => (
          <div key={id} className="relative h-96 rounded-lg overflow-hidden shadow-md">
            <ImageDisplay
...
ProjectLayoutSection.propTypes = {
